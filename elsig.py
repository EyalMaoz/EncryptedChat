...
def signMessage(message):
    ...
    p = libnum.generate_prime(bits)#Crypto.Util.number.getPrime(bits, randfunc=Crypto.Random.get_random_bytes)  # large prime p
    ...
    e = libnum.generate_prime(bits)#Crypto.Util.number.getPrime(bits, randfunc=Crypto.Random.get_random_bytes)
